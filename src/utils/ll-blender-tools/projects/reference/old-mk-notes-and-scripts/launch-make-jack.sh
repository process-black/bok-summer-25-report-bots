...
BLENDER_WORK_FOLDER="$HOME/Dropbox (MLV)/shared-2019/mk_sync_2019/blender"
...
echo $RENDER_PATH
PYTHON_SCRIPT="$HOME/Development/the-tools/tools/scripts/blender/make-jackolantern.py"
